...
import jwtspring3.model.UserPrinciple;
import jwtspring3.repository.RoleRepository;
import jwtspring3.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public Iterable<User> findAllByRoles(String nameRoles) {
        Role role = roleRepository.findByName(nameRoles);
